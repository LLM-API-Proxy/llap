...
[![Version](https://img.shields.io/badge/version-0.0.151-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.151)
...
> Release **v0.0.151** · 2026-08-28T06:13:24Z · `156677d6b4dd76828aa1d2741192a2a6b8de78fe`
...
# base_url="https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.151"
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.151/llap-linux-amd64) |
| Linux ARM64 | [llap-linux-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.151/llap-linux-arm64) |
| macOS x86-64 | [llap-darwin-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.151/llap-darwin-amd64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.151/llap-darwin-arm64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl --disable -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.151/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.151` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.151` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.151` | Restic backup agent |
...
| `0.0.151` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.151
```
