...
[![Version](https://img.shields.io/badge/version-0.0.135-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.135)
...
> Release **v0.0.135** · 2026-08-03T03:18:35Z · `d2e5537a5ad4478ea1d61ea95ce41fc9a6d879c7`
...
# base_url="https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.135"
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.135/llap-linux-amd64) |
| Linux ARM64 | [llap-linux-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.135/llap-linux-arm64) |
| macOS x86-64 | [llap-darwin-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.135/llap-darwin-amd64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.135/llap-darwin-arm64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl --disable -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.135/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.135` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.135` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.135` | Restic backup agent |
...
| `0.0.135` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.135
```
