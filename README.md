...
[![Version](https://img.shields.io/badge/version-0.0.127-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.127)
...
> Release **v0.0.127** · 2026-07-15T11:55:59Z · `2df809aadecec4686166904b1dd167bc506a2331`
...
# base_url="https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.127"
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.127/llap-linux-amd64) |
| Linux ARM64 | [llap-linux-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.127/llap-linux-arm64) |
| macOS x86-64 | [llap-darwin-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.127/llap-darwin-amd64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.127/llap-darwin-arm64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl --disable -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.127/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.127` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.127` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.127` | Restic backup agent |
...
| `0.0.127` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.127
```
