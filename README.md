...
[![Version](https://img.shields.io/badge/version-0.0.27-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.27)
...
> Release **v0.0.27** · 2026-04-17T14:56:01Z · `ffd6ddd`
...
```bash
curl -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.27/install.sh | bash
```
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-x86_64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.27/llap-linux-x86_64) |
| Linux ARM64 | [llap-linux-aarch64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.27/llap-linux-aarch64) |
| macOS x86-64 | [llap-darwin-x86_64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.27/llap-darwin-x86_64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-aarch64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.27/llap-darwin-aarch64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.27/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.27` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.27` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.27` | Restic backup agent |
...
| `0.0.27` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.27
```
