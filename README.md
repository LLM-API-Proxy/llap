...
[![Version](https://img.shields.io/badge/version-0.0.139-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.139)
...
> Release **v0.0.139** · 2026-08-14T01:25:42Z · `ea0b5375c1148e50ca328cab9e8eb7a5aa55e059`
...
# base_url="https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.139"
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.139/llap-linux-amd64) |
| Linux ARM64 | [llap-linux-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.139/llap-linux-arm64) |
| macOS x86-64 | [llap-darwin-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.139/llap-darwin-amd64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.139/llap-darwin-arm64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl --disable -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.139/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.139` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.139` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.139` | Restic backup agent |
...
| `0.0.139` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.139
```
