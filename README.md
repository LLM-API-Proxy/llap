...
[![Version](https://img.shields.io/badge/version-0.0.171-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.171)
...
> Release **v0.0.171** · 2026-09-19T22:07:10Z · `44ebed6a94a811dfb84b73a9363b659a55237836`
...
# base_url="https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.171"
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.171/llap-linux-amd64) |
| Linux ARM64 | [llap-linux-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.171/llap-linux-arm64) |
| macOS x86-64 | [llap-darwin-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.171/llap-darwin-amd64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.171/llap-darwin-arm64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl --disable -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.171/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.171` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.171` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.171` | Restic backup agent |
...
| `0.0.171` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.171
```
