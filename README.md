...
[![Version](https://img.shields.io/badge/version-0.0.128-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.128)
...
> Release **v0.0.128** · 2026-07-15T13:35:24Z · `c5d973d8b7d698ad48ad3f61a86fa88f1ba02098`
...
# base_url="https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.128"
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.128/llap-linux-amd64) |
| Linux ARM64 | [llap-linux-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.128/llap-linux-arm64) |
| macOS x86-64 | [llap-darwin-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.128/llap-darwin-amd64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.128/llap-darwin-arm64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl --disable -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.128/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.128` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.128` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.128` | Restic backup agent |
...
| `0.0.128` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.128
```
