...
[![Version](https://img.shields.io/badge/version-0.0.50-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.50)
...
> Release **v0.0.50** · 2026-05-04T16:02:32Z · `1e2f29d`
...
```bash
curl -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.50/install.sh | bash
```
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-x86_64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.50/llap-linux-x86_64) |
| Linux ARM64 | [llap-linux-aarch64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.50/llap-linux-aarch64) |
| macOS x86-64 | [llap-darwin-x86_64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.50/llap-darwin-x86_64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-aarch64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.50/llap-darwin-aarch64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.50/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.50` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.50` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.50` | Restic backup agent |
...
| `0.0.50` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.50
```
