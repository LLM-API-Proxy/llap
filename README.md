...
[![Version](https://img.shields.io/badge/version-0.0.167-blue)](https://github.com/LLM-API-Proxy/llap/releases/tag/v0.0.167)
...
> Release **v0.0.167** · 2026-09-15T15:52:12Z · `763790fe7fbf93be800214c53eda66f36cc2c7d4`
...
# base_url="https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.167"
...
| Platform | Download |
|---|---|
| Linux x86-64 | [llap-linux-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.167/llap-linux-amd64) |
| Linux ARM64 | [llap-linux-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.167/llap-linux-arm64) |
| macOS x86-64 | [llap-darwin-amd64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.167/llap-darwin-amd64) |
| macOS ARM64 (Apple Silicon) | [llap-darwin-arm64](https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.167/llap-darwin-arm64) |

Verify the checksum after downloading:

```bash
# Download the checksum file
curl --disable -fsSL https://github.com/LLM-API-Proxy/llap/releases/download/v0.0.167/llap-SHA256SUMS -o llap-SHA256SUMS
...
| Image | Tag |
|---|---|
| `ghcr.io/llm-api-proxy/server:0.0.167` | Proxy server |
| `ghcr.io/llm-api-proxy/cli:0.0.167` | Management CLI |
| `ghcr.io/llm-api-proxy/backup:0.0.167` | Restic backup agent |
...
| `0.0.167` | Exact version (e.g. `1.2.3`) |
...
```bash
docker pull ghcr.io/llm-api-proxy/server:0.0.167
```
